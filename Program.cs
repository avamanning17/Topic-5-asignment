...
namespace Topic_5_asignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double firstNumber, secondNumber, equation;
            string sign;

            Console.WriteLine("What is the first number youd like to insert?");
            Double.TryParse(Console.ReadLine(), out firstNumber);
            Console.WriteLine("What is the sign you would like to insert?");
            sign =  Console.ReadLine();
            Console.WriteLine("What is the second number you would like to insert?");
